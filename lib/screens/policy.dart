...
In compliance with the CAN-SPAM Act, all e-mails sent from us will clearly state who the e-mail is from and provide clear information on how to contact the sender. You may choose to stop receiving our newsletter or marketing emails by following the unsubscribe instructions included in these emails or by contacting us. However, you will continue to receive essential transactional emails.'''),
                    ...
                    Text(
                        '''If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may send an email to admin@scoolspro.com.
            ...
            ScrollOnExpand(
              ...
              child: ExpandablePanel(
                ...
                expanded: Column(
                  ...
                  children: <Widget>[
                    Text(
                        '''1.The purpose of collecting personal Data is to perfrom research and analysis about your use of, or interest in, our products, services ,or content,or products, services and content offerded by others and communicate with you email, postal email and/or electronic devices.'''),
                    SizedBox(
                      height: 8,
                    ),
                    Text(
                        '''2.Personal Information is kept for as long as required to fulfill the purpose for which they are collected.Thereafter we will delete the personal information.'''),
                    SizedBox(
                      height: 8,
                    ),
                    Text(
                        '''3. The Personal Data collected will not be disclosed to third party other than those specified by your express approval or unless required by law.'''),
                    SizedBox(
                      height: 8,
                    ),
                    Text(
                        '''4.Unless indicated otherwise, all personal data requested in this form is required for its purpose(s).If such data is incomplete ir inaccurate, your use of the website and application will be void or delayed'''),
                    SizedBox(
                      height: 8,
                    ),
                    Text(
                        '''5.You have the right to request acces and correction of the personal data under Hong Kong's Personal Data (Privacy) Ordinance (cap. 486). For such request, please contact our Privacy Manager at privacy@scoolspro.com/contact.html or'''),
                    InkWell(
                      child: Text('Click here',
                          style: TextStyle(color: Color(0xff3575B6))),
