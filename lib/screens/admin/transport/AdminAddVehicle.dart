                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        snapshot.data.assignVehicle[index].vehicleModel,
                                        maxLines: 1,
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        snapshot.data.assignVehicle[index].vehicleNo.toString(),
                                        style: Theme.of(context).textTheme.headline4,
                                      ),
                                    ],
                                  ),
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        snapshot.data.assignVehicle[index].madeYear.toString(),
                                        style: Theme.of(context).textTheme.headline4,
                                      ),
                                    ],
                                  ),
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: TextField(
              ...
              style: Theme.of(context).textTheme.headline4,
              decoration: InputDecoration(hintText: 'Year Made'),
            ),
          ),
