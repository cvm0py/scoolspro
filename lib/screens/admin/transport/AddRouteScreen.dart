...
class _AddRouteState extends State<AddRoute> {
      ...
      child: Column(
        children: [
          TextField(
            ...
            style: Theme.of(context).textTheme.headline4,
            decoration: InputDecoration(hintText: 'Route title here'),
          ),
          TextField(
            controller: fareController,
            style: Theme.of(context).textTheme.headline4,
            decoration: InputDecoration(hintText: 'Enter fare here'),
          ),
          Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                addFeeData(titleController.text, fareController.text, id)
                    .then((value) {
                  if (value) {
  ...
  Future<bool> addFeeData(String title, String fare, String uid) async {
    print(InfixApi.addRoute(title, fare, uid));
    response = await dio
        .post(
