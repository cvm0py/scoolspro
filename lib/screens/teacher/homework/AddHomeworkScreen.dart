  ...
  Widget getClassDropdown(List<Classes> classes) {
    return Container(
      ...
      child: DropdownButton(
        ...
        style: Theme.of(context).textTheme.headline4.copyWith(fontSize: ScreenUtil().setSp(14)),
        onChanged: (value) {
          setState(() {
  ...
  Widget getSectionDropdown(List<Section> sectionlist) {
    return Container(
      ...
      child: DropdownButton(
        ...
        style: Theme.of(context).textTheme.headline4.copyWith(fontSize: ScreenUtil().setSp(15.0)),
        onChanged: (value) {
          setState(() {
      ...
      child: DropdownButton(
        ...
        items: subjectList.map((item) {
          return DropdownMenuItem<String>(
            ...
            child: Padding(
              padding: const EdgeInsets.only(left: 8.0,bottom:10),
              child: Text(item.subjectName,style: Theme.of(context).textTheme.headline4,),
            ),
          );
        }).toList(),
