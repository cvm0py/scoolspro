...
class _ApplyLeaveScreenState extends State<ApplyLeaveScreen> {
    ...
    return Padding(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: Column(
          ...
          children: [
            leaveAvailable ? GestureDetector(
              child: Padding(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  ...
                                  style: Theme.of(context)
                                      .textTheme
                                      .headline4
                                      .copyWith(fontSize: ScreenUtil().setSp(12.0)),
                                ),
                              ),
                            ),
                            Icon(
  ...
  Widget getLeaveTypeDropdown(List<LeaveType> leaves) {
    return leaveAvailable ? Container(
      width: MediaQuery.of(context).size.width,
        ...
        items: leaves.map((item) {
          return DropdownMenuItem<String>(
            ...
            child: Padding(
              ...
              child: Text(item.type,style: Theme.of(context).textTheme.headline4,),
            ),
          );
        }).toList(),
  ...
  void uploadLeave() async {
    ...
    if (response.statusCode == 200) {
      Utils.showToast('Leave applied. Please wait for approval');
      sentNotificationTo();
