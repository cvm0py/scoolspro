...
class AppFunction {
  ...
  static var studentIcons = [
    ...
    'assets/images/fees_icon.gif',
    'assets/images/routine.gif',
    'assets/images/homework.gif',
    'assets/images/downloads.png',
    'assets/images/attendance.gif',
    'assets/images/examination.gif',
    'assets/images/onlineexam.png',
    //'assets/images/leave.png',
    'assets/images/notice.gif',
    'assets/images/subjects.gif',
    'assets/images/teacher.gif',
    'assets/images/library.gif',
    'assets/images/transport.gif',
    ...
    switch (rule) {
      ...
      case '2':
        if (zoom == '1') {
          ...
          route = MaterialPageRoute(
              builder: (context) => Home(students2, studentIcons2));
          Navigator.pushReplacement(context, route);
        }
        break;
      case '3':
